public class Aritmetica {
		...
		int  a;//Los valores por defecto son cero
		int  b;
		
		//Constructor Vacio 
		//El constructor es un metodo especial que se manda a llamar cuando se crea el objeto
		public Aritmetica() {
		...
		public int sumarConArgumentos(int a, int b) {
			...
			this.b = b; 
			//return a + b;	
			return this.sumarConRetorno();//Reutilizamos el segundo método previamente definido y el operador
			//this esta referenciando al metodo de la clase actual
			}
